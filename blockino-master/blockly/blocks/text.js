...
Blockly.Blocks['text_prompt_ext'] = {
  ...
  updateType_: function(newOp) {
    if (newOp == Blockly.StaticTyping.BlocklyType.NUMBER || newOp.toUpperCase() == Blockly.StaticTyping.getType(Blockly.StaticTyping.BlocklyType.NUMBER)) {
  ...
  mutationToDom: function() {
    ...
    if (type == Blockly.StaticTyping.BlocklyType.NUMBER || 
         type.toUpperCase() == Blockly.StaticTyping.getType(Blockly.StaticTyping.BlocklyType.NUMBER))
        container.setAttribute('type', Blockly.StaticTyping.BlocklyType.NUMBER);
    else
        container.setAttribute('type', Blockly.StaticTyping.BlocklyType.TEXT);
    return container;
  },
  /**
  ...
  domToMutation: function(xmlElement) {
     ...
     if (type == Blockly.StaticTyping.BlocklyType.NUMBER || 
            type.toUpperCase() == Blockly.StaticTyping.getType(Blockly.StaticTyping.BlocklyType.NUMBER))
        this.updateType_(Blockly.StaticTyping.BlocklyType.NUMBER);
    else
        this.updateType_(Blockly.StaticTyping.BlocklyType.TEXT);
  ...
  getBlockType: function() {
    ...
    if (type == Blockly.StaticTyping.BlocklyType.NUMBER || 
            type.toUpperCase() == Blockly.StaticTyping.getType(Blockly.StaticTyping.BlocklyType.NUMBER))
        return Blockly.StaticTyping.BlocklyType.NUMBER;
    else
        return  Blockly.StaticTyping.BlocklyType.TEXT;
  }
...
Blockly.Blocks['text_prompt'] = {
  ...
  getBlockType: Blockly.Blocks['text_prompt_ext'].getBlockType
};
