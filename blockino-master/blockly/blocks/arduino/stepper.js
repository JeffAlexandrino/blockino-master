...
Blockly.Blocks['stepper_config'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendField('Configura')
        .appendField(new Blockly.FieldTextInput('MotorPasso'), 'STEPPER_NAME')
        .appendField('motor de passo:');
    this.appendDummyInput()
    ...
    this.appendValueInput('STEPPER_STEPS')
        ...
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField('quantos passos por revolução');
    this.appendValueInput('STEPPER_SPEED')
        .setCheck(Blockly.StaticTyping.BlocklyType.NUMBER)
        .setAlign(Blockly.ALIGN_RIGHT)
        .appendField('configura velocidade (rpm) para');
    this.setTooltip('Configura motor de passo do pino e outras configurações.');
  },
  /**
