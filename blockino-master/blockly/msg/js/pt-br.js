...
Blockly.Msg.filename = "Nome_do_arquivo";
Blockly.Msg.sourcecode= "Código Fonte";
Blockly.Msg.open= "Abrir";
Blockly.Msg.savexml= "Salvar blocos";
Blockly.Msg.saveino= "Salvar .ino";
Blockly.Msg.examples= "Exemplos";
Blockly.Msg.language= "Idioma";
Blockly.Msg.example_1= "Pisca led";
Blockly.Msg.example_2= "Serial";
Blockly.Msg.example_3= "Jogo da Repetição";
Blockly.Msg.example_4= "Controle de Servo";
Blockly.Msg.example_5= "Sensor Hall";
Blockly.Msg.example_6= "Pisca quarto"; //   Guilherme volpato
Blockly.Msg.example_7= "Temperatura e Umidade"; // Guilherme Volpato
Blockly.Msg.deleteall= "Excluir tudo";
Blockly.Msg.protoboarddiagram= "Diagrama do circuito";
Blockly.Msg.codeverifying= "Verificando código";
Blockly.Msg.outputIDEArduino= "Saída da IDE Arduino";
Blockly.Msg.livestreming= "Transmissão remota";
Blockly.Msg.serialmonitor= "Terminal serial";
Blockly.Msg.commands= "Comandos";
Blockly.Msg.entertosend= "Enter para enviar";
Blockly.Msg.logic="Lógicos";
Blockly.Msg.loops="Iterações";
Blockly.Msg.math= "Matemáticos";
Blockly.Msg.text = "Textuais";
Blockly.Msg.functions = "Funções";
Blockly.Msg.io = "Entrada/saída";
Blockly.Msg.variables= "Variáveis";
Blockly.Msg.time= "Tempo";
Blockly.Msg.motors= "Motores";
Blockly.Msg.comms= "Comunicação";
Blockly.Msg.displays= "Visores";
Blockly.Msg.sensors = "Sensores";
Blockly.Msg.Iluminação = "Iluminação"; // criado por Guilherme Chaves Volpato
Blockly.Msg.Desligar = "Desligar"; // criado por Guilherme Chaves Volpato
Blockly.Msg.tempumi = "Temperatura e Umidade"; // criado por Guilherme Chaves Volpato
Blockly.Msg.Cômodos = "Cômodos"; // criado por Guilherme Chaves Volpato
Blockly.Msg.quarto = "Quarto"; // criado por Guilherme Chaves Volpato
Blockly.Msg.varanda = "Varanda"; // criado por Guilherme Chaves Volpato
Blockly.Msg.banheiro = "Banheiro"; // criado por Guilherme Chaves Volpato
Blockly.Msg.sala = "Sala de estar"; // criado por Guilherme Chaves Volpato
Blockly.Msg.cozinha = "Cozinha"; // criado por Guilherme Chaves Volpato
...
Blockly.StaticTyping.BlocklyType = {
  ...
  NUMBER: 'Numero',            // A general number type
  ...
  UNDEF: 'Nao definido',          // Used to delegate type set to other blocks
  UNSPECIFIED: 'Nao especificado',  // Error, when block has not defined its var type
...
Blockly.Msg.if_word= "se";
Blockly.Msg.do_word = "faça";
Blockly.Msg.not_word = "não";
Blockly.Msg.test_word = "testa";
Blockly.Msg.if_true= "se verdade";
Blockly.Msg.if_false= "se falso";
Blockly.Msg.repeat_word = "repita";
Blockly.Msg.times = "vezes";
Blockly.Msg.while_word = "enquanto";
Blockly.Msg.until_word = "até";
Blockly.Msg.count_with= "conte com"; 
Blockly.Msg.to_word = "para";
Blockly.Msg.to_word2 = "a";
Blockly.Msg.by_word = "por";
Blockly.Msg.as_word = "como";
Blockly.Msg.break_out = "parada";
Blockly.Msg.continue_next_iteration = "continue na próxima iteração";
Blockly.Msg.of_loop = "do loop";
Blockly.Msg.square_root= "raiz quadrada";
Blockly.Msg.absolute= "valor absoluto";
Blockly.Msg.sin= "sen";
Blockly.Msg.asin= "asen";
Blockly.Msg.even= "par";
Blockly.Msg.odd= "ímpar";
Blockly.Msg.prime= "primo";
Blockly.Msg.whole= "inteiro";
Blockly.Msg.positive= "positivo";
Blockly.Msg.negative= "negativo";
Blockly.Msg.divisible_by= "divisível por";
Blockly.Msg.change= "troque";
Blockly.Msg.round = "arredonda";
Blockly.Msg.round_up= "arredonda para cima";
Blockly.Msg.round_down= "arredonda para baixo";
Blockly.Msg.remainder_of= "resto de";
Blockly.Msg.constrain= "restringe";
Blockly.Msg.lower_than= "menor que";
Blockly.Msg.higher_than= "maior que";
Blockly.Msg.random_integer_from= "inteiro aleatório entre";
Blockly.Msg.random_to= "e";
Blockly.Msg.random_fraction= "fração aleatória";
Blockly.Msg.map = "mapear";
Blockly.Msg.value_to= "valor de";
Blockly.Msg.create_text= "cria texto com";
Blockly.Msg.append_text= "acrescenta texto";
Blockly.Msg.length_of= "comprimento de";
Blockly.Msg.is_empty= "é vazio?";
Blockly.Msg.set_word= "atribui";
Blockly.Msg.do_something = "faça alguma coisa";
Blockly.Msg.return_word= "retorne";
Blockly.Msg.run_only_once= "executa uma vez somente (setup)";
Blockly.Msg.run_loop= "executa repetidamente (loop)";
Blockly.Msg.set_digital_pin= "ajusta pino digital";
Blockly.Msg.read_digital_pin="lê pino digital";
Blockly.Msg.set_led= "ajusta LED";
Blockly.Msg.set_analog_pin= "ajusta pino analógico";
Blockly.Msg.read_analog_pin= "lê pino analógico";
Blockly.Msg.wait= "espera";
Blockly.Msg.miliseconds="milisegundos";
Blockly.Msg.microseconds="microsegundos";
Blockly.Msg.elapsed_time= "tempo passado até o momento";
Blockly.Msg.wait_forever= "espera para sempre (fim do programa)";
Blockly.Msg.set_servo_pin="posiciona servo do pino";
Blockly.Msg.degrees="graus (0-180)";
Blockly.Msg.read_servo_pin= "lê servo do pino";
Blockly.Msg.setup="configura";
Blockly.Msg.speed = "velocidade de";
Blockly.Msg.add_new_line="inserir quebra de linha";
Blockly.Msg.print_word="imprime";
Blockly.Msg.prompt_for="solicita";
Blockly.Msg.with_message= "com mensagem";
Blockly.Msg.clear_display="limpa visor LCD";
Blockly.Msg.print_display= "imprime no visor LCD";
Blockly.Msg.set_cursor_display= "posiciona cursor do visor LCD na coluna";
Blockly.Msg.humidity = "Umidade";
Blockly.Msg.temperature = "Temperatura";
Blockly.Msg.luzquarto = "Luz do quarto"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.ventiladorquarto = "Ventilador do quarto"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.abajurquarto = "Abajur do quarto"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.aquecedorquarto = "Aquecedor do quarto"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.abajurquarto = "Abajur do quarto"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.luzbanheiro = "Luz do banheiro"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.luzvaranda = "Luz da varanda"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.luzsala = "Luz da sala"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.televisaosala = "Televisão da sala"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.luzcozinha = "Luz da cozinha"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.fogaocozinha = "Fogão"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.Vermelho = "Vermelho"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.Verde = "Verde"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.Azul = "Azul"; // Criado por Guilherme Chaves Volpato
Blockly.Msg.and_row="e linha";     
Blockly.Msg.tooltip_lcd_escreve= "Imprime dado no LDC 16x2 em texto ASCII.";
Blockly.Msg.tooltip_lcd_clear= "Limpa todos caracteres escritos no LCD";
Blockly.Msg.tooltip_lcd_posicao= "Posiciona o cursor para escrita no visor LCD na posição (linha, coluna)";
Blockly.Msg.tooltip_set_servo_pin= "Posiciona um servo motor em um ângulo específico.";
Blockly.Msg.tooltip_read_servo_pin= "Le ângulo de um servo motor";
Blockly.Msg.tooltip_serial_setup= "Seleciona uma velocidade específica para o periférico Serial.";
Blockly.Msg.tooltip_serial_print= "Imprime dado no console/porta serial como texto ASCII legível por humanos.";
Blockly.Msg.tooltip_map = "Mapeia um número dentro de uma faixa de valores para outra. Ex.: [0-1024] para [0-255]";
Blockly.Msg.tooltip_set_type= "Ajusta um valor para um tipo específico.";
Blockly.Msg.tooltip_wait_mili= "Espera por um tempo específico em milisegundos.";
Blockly.Msg.tooltip_wait_micro= "Espera por um tempo específico em microssegundos.";
Blockly.Msg.tooltip_time_milli= "Retorna o número de milisegundos desde que a placa Arduino começou a executar o programa atual.";
Blockly.Msg.tooltip_time_micro= "Retorna o número de microsegundos desde que a placa Arduino começou a executar o programa atual.";
Blockly.Msg.tooltip_wait_forever= "Espera indefinidamente parando o programa.";
Blockly.Msg.tooltip_digital_write= "Escreve valor digital (0 ou 1) em um pino específico.";
Blockly.Msg.tooltip_digital_read= "Lê valor digital (0 ou 1) de um pino.";
Blockly.Msg.tooltip_led= "Liga ou desliga um LED conectado a um pino digital.";
Blockly.Msg.tooltip_analog_write= "Escreve um valor analógico entre 0 e 255 em um pino específico";
Blockly.Msg.tooltip_analog_read= "Retorna um valor entre 0 e 1024.";
Blockly.Msg.tooltip_high_low= "Ajusta um pino no estado lógico High ou Low.";
Blockly.Msg.tooltip_setup_loop= "Defines the Arduino setup() and loop() functions.";
Blockly.Msg.deleteblocks= "Excluir blocos?";
Blockly.Msg.deleteblocks_confirm= "Há %blocks blocos na área de trabalho. Tem certeza que você quer excluir eles?";
Blockly.Msg.verifying= 'Verificando código...';
Blockly.Msg.requesting= 'Solicitando acesso, aguarde...';
Blockly.Msg.upload_success= "Upload realizado com sucesso.";
Blockly.Msg.compile_success= "Código compilado com sucesso";
Blockly.Msg.error_conclusion= "Não foi possível executar a ação na IDE remota";
Blockly.Msg.warningWrongType = 'A variável %vName foi previamente declarada com o tipo "%vType" e este bloco precisa que ela seja do tipo "%bType" !';
Blockly.Msg.shep_editor = 'O editor de códigos consiste em uma caixa de ferramenta, onde você seleciona os blocos, e um espaço de trabalho, onde você arrasta os blocos';
Blockly.Msg.shep_thrash = 'Há uma lixeira para excluir os blocos arrastados para ela';
Blockly.Msg.shep_categories = 'A caixa de ferramentas possui todos os blocos necessários organizados em categorias';
Blockly.Msg.shep_navbar = 'Renomeie seu arquivo para baixar seu código. Você também pode iniciar este tour novamente e acessar a documentação';
Blockly.Msg.shep_menu = 'Neste menu encontram-se alguns exemplos, tradução, e outras funções úteis';
Blockly.Msg.shep_code = 'O código fonte na linguagem do Arduino é automaticamente gerado neste espaço';
Blockly.Msg.shep_diagram = 'Esta figura representa o circuito montado. Ela é útil na identificação dos sensores e pinos que serão utilizados durante o desenvolvimento de seu programa';
Blockly.Msg.shep_buttons = 'Use o botão vermelho para compilar seu código e o botão azul para executar o programa';
Blockly.Msg.shep_debug_video = "É possível ver o que está acontecendo no momento através desta transmissão de vídeo";
Blockly.Msg.shep_debug_serial = "Se você utilizar as funções da comunicação serial do Arduino no seu código, será possível trocar informações com a placa neste terminal";
Blockly.Msg.shep_output = "Após compilar ou enviar, o retorno destas ações aparecerão neste espaço indicando se elas foram executadas com sucesso ou não";
Blockly.Msg.exit = "Sair";  
